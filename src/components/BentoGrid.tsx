...
export const BentoCard = ({
  ...
  return (
    ...
    >
      {/* Background Decor */}
      <div className="pointer-events-none absolute inset-0 transition-opacity duration-500 group-hover:bg-gradient-to-br from-pink-50/40 via-transparent to-blue-50/40 opacity-0 group-hover:opacity-100" />
      
      {icon && <div className="relative z-10 mb-4 text-slate-400 group-hover:text-pink-400 transition-colors duration-300">{icon}</div>}
